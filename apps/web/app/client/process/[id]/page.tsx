...
import { maskCep, maskCpf, maskIptu, maskPercent, maskPhone } from "@/lib/masks";
...
const documentTypes = [
  {
    ...
    description:
      "RG, CNH ou Documento Profissional. Se o sócio for pessoa jurídica, anexar contrato social/alteração + identificação do representante."
  },
  {
                ...
                <div className="mt-4 grid gap-4 md:grid-cols-2">
                  ...
                  <Field label="Telefone do CNPJ" required hint="Com DDD e WhatsApp se possível.">
                    <Input
                      ...
                      onChange={(event) => setStep2((prev) => ({ ...prev, telefoneCnpj: maskPhone(event.target.value) }))}
                      disabled={!formEditable}
                      inputMode="numeric"
                      maxLength={15}
                    />
              ...
              <Card className="p-6">
                      ...
                      />
                        ...
                        <Field label="Telefone do sócio" required hint="Com DDD e WhatsApp se possível.">
                          <Input
                            ...
                            onChange={(event) => updateSocio(index, "socioTelefone", maskPhone(event.target.value))}
                            disabled={!formEditable}
                            inputMode="numeric"
                            maxLength={15}
                          />
                ...
                <div className="mt-6 rounded-2xl border border-ink/10 bg-white/90 p-4">
                  ...
                  <p className="mt-1 text-xs text-slate">
                    Use este chat para tirar dúvidas sobre documentos, dados e prazos.
                  </p>
                  <div className="mt-4 max-h-72 space-y-3 overflow-y-auto rounded-xl border border-ink/5 bg-white/70 p-3">
              ...
              <Card className="p-6">
                ...
                <div className="mt-4 rounded-2xl border border-brass/20 bg-brass/5 p-4 text-sm text-slate">
                  ...
                  <p className="mt-3 text-xs text-slate">
                    Você pode enviar mais de um arquivo por item. Para juntar tudo em um único PDF, use o{" "}
                    <a
