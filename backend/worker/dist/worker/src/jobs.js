...
exports.cancelInactiveProcesses = cancelInactiveProcesses;
...
async function cancelInactiveProcesses() {
    const fiveDaysAgo = (0, dayjs_1.default)().subtract(5, "day").toDate();
