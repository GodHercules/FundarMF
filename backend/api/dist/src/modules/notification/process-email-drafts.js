...
exports.buildProcessEmailDrafts = buildProcessEmailDrafts;
...
const stepsOrder = ["ETAPA_1", "ETAPA_2", "ETAPA_3", "ETAPA_4", "ETAPA_5", "ETAPA_6"];
function computeProgressPercent(currentStep, status) {
    if (status === "CONCLUIDO")
        return 100;
...
function render(subject, lines, cta) {
    const { html, text } = (0, email_template_1.renderBaseEmail)({
        title: subject,
...
function buildProcessEmailDrafts(input) {
...
//# sourceMappingURL=process-email-drafts.js.map